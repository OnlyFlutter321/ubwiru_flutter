              ...
              return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            Get.to(() => Product(itemdata!.data![index].id));
                          },
                          child: Column(children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  itemdata!
                                      .data![index].categoryInfo!.categoryName,
                                  style: TextStyle(
                                    fontSize: 11,
                                    fontFamily: 'Poppins',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  ] else if (itemdata!.data![index].isCart ==
                                      "0") ...[
                                    InkWell(
                                      onTap: () async {
